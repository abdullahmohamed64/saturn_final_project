      ...
      children: [
        CircleAvatar(
          ...
          userModel.picName!=null ?
            NetworkImage(ApiConstants.upload + userModel.picName!)
          : AssetImage(Assets.assetsImagesUserAvatar),),
        verticalSpace(8),
        Text(userModel.username ?? 'no name' , style: AppTextstyles.font14GreyRegular.copyWith(color: AppColors.theMostlightGrey),)
      ],
    );
  }
}